...
export function InstallBanner() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 bg-cream border-b border-border shadow-sm animate-slide-up">
      <div className="max-w-md mx-auto px-6 py-4 flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-text-secondary text-xs">Install Cupla for quick access.</p>
          </div>
        </div>
